...
BEGIN TRY
    ...
    VALUES ('Dwight', 'Schrute', '1987-01-20', 'dwight.schrute@example.com', 'beetfarm2023', 'customer', SYSDATETIME());
    ...
    VALUES (@customerID, 50.00, DATEADD(DAY, -7, SYSDATETIME()), 'credit card', 'completed');
    ...
    PRINT 'Customer 4 and related data added successfully.';
END TRY
BEGIN CATCH
