...
BEGIN TRY
    ...
    VALUES ('Stanley', 'Hudson', '1970-07-14', 'stanley.hudson@example.com', 'pretzelday2023', 'customer', SYSDATETIME());
    ...
    VALUES (@customerID, 50.00, DATEADD(DAY, -20, SYSDATETIME()), 'PayPal', 'completed');
    ...
    PRINT 'Customer 6 and related data added successfully.';
END TRY
BEGIN CATCH
