...
BEGIN TRY
    ...
    VALUES ('Angela', 'Martin', '1980-12-01', 'angela.martin@example.com', 'catlady2024', 'customer', SYSDATETIME());
    ...
    VALUES (@customerID, 600.00, SYSDATETIME(), 'PayPal', 'completed');
    ...
    -- Step 6: Book a Boxing Class
    INSERT INTO tblClassBooking (customerID, classID, bookingDate, status)
    VALUES (@customerID, 6, SYSDATETIME(), 'confirmed');
    ...
    VALUES (@customerID, @attendanceID, 60, 60, 1, SYSDATETIME(), 1);

    -- Commit the transaction
    COMMIT TRANSACTION;

    PRINT 'Customer 12 and related data added successfully.';
END TRY
BEGIN CATCH
