...
BEGIN TRY
    ...
    VALUES ('Kelly', 'Kapoor', '1995-06-10', 'kelly.kapoor@example.com', 'fashionqueen123', 'customer', SYSDATETIME());
    ...
    VALUES (@customerID, 50.00, DATEADD(DAY, -15, SYSDATETIME()), 'credit card', 'completed');
    ...
    VALUES (@customerID, 1, DATEADD(DAY, -1, SYSDATETIME()), 'attended');
    ...
    VALUES (@attendanceID, @customerID, DATEADD(HOUR, -2, DATEADD(DAY, -1, SYSDATETIME())), DATEADD(HOUR, -1, DATEADD(DAY, -1, SYSDATETIME())));
    ...
    VALUES (@customerID, @attendanceID, @bookingID, @gymCheckInID, DATEADD(HOUR, -1, DATEADD(DAY, -1, SYSDATETIME())), SYSDATETIME());
    ...
    PRINT 'Customer 5 and related data added successfully.';
END TRY
BEGIN CATCH
