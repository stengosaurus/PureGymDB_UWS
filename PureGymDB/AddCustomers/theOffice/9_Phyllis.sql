...
BEGIN TRY
    ...
    VALUES ('Phyllis', 'Vance', '1965-07-01', 'phyllis.vance@example.com', 'knittingclub2024', 'customer', SYSDATETIME());
    ...
    VALUES (@customerID, @attendanceID, 120, 60, 2, SYSDATETIME(), 2);

    -- Commit the transaction
    COMMIT TRANSACTION;

    PRINT 'Customer 9 and related data added successfully.';
END TRY
BEGIN CATCH
